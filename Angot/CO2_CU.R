...
# Load Dataset
packageId <- "resource_map_urn:uuid:0ec85326-243d-453a-9602-1db39e22cf86"
...
## -- add public read for data -- ##
ids <- getIdentifiers(dp)
set_public_read(d1c@mn, c(xml, ids[2], packageId))


## -- update package w/new xml name -- ##
# Write EML
eml_path <- "~/Scratch/CO2_CU_dry_air_mole_fraction_min_avg.xml"
